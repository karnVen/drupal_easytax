...
class __TwigTemplate_7d277d8148803c756ec5aabaaff6d714 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        // line 12
        $context["content_link_text"] = ('' === $tmp = implode('', iterator_to_array((function () use (&$context, $macros, $blocks) {
            yield t("Content", []);
            yield from [];
        })(), false))) ? '' : new Markup($tmp, $this->env->getCharset());
        // line 13
...
<ol>
  <li>";
        // line 20
        yield t("Find the entity that you want to moderate in either the content moderation view page, if you created one, or the appropriate administrative page for managing that type of entity (such as the administration page for content items; see @content_link).", ["@content_link" => $this->env->getExtension(\Drupal\Core\Template\TwigExtension::class)->renderVar(($context["content_link"] ?? null)), ]);
        yield "</li>
  <li>";
        // line 21
        yield t("Click <em>Edit</em> to edit the entity.", []);
        yield "</li>
  <li>";
        // line 22
        yield t("At the bottom of the page, select the new workflow state under <em>Change to:</em> and click <em>Save</em>.", []);
        yield "</li>
</ol>";
        yield from [];
    }
    ...
    {
        return new Source("", "@help_topics/content_moderation.changing_states.html.twig", "/home/karnven/drupal/web/core/modules/content_moderation/help_topics/content_moderation.changing_states.html.twig");
    }
