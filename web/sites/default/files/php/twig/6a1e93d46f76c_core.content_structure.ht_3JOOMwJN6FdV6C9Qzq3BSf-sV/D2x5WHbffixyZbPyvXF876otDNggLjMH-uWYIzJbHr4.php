...
class __TwigTemplate_f78f9dd6333fafd19a263e34deaaaa45 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 5
        $context["help_link_text"] = ('' === $tmp = implode('', iterator_to_array((function () use (&$context, $macros, $blocks) {
            yield t("Help", []);
            yield from [];
...
<p>";
        // line 8
        yield t("There are four main types of data. <em>Content</em> is the information (text, images, etc.) meant to be displayed to website visitors. <em>Configuration</em> is data that defines how the content is displayed; some configuration (such as field labels) may also be visible to site visitors. <em>State</em> is temporary data about the state of your site, such as the last time the system <em>cron</em> jobs ran. <em>Session</em> is a subset of State information, related to users\x27 interactions with the site, such as site cookies and whether or not they are logged in.", []);
        yield "</p>
<h2>";
        // line 9
...
<p>";
        // line 34
        yield t("A <em>formatter</em> is a way to display a field; most field types offer several types of formatters, and most formatters have settings that further define how the field is displayed. It is also possible to completely hide a field from display, and you have the option of showing or hiding the field\x27s label when it is displayed.", []);
        yield "</p>
<h2>";
        // line 35
...
<ul>
  <li>";
        // line 40
        yield t("The core Node, Comment, Content Block, Custom Menu Links, User, File, Image, Media, and Taxonomy modules all provide content entity types.", []);
        yield "</li>
  <li>";
        // line 41
...
<ul>
  ...
  <li>";
    ...
    {
        return new Source("", "@help_topics/core.content_structure.html.twig", "/home/karnven/drupal/web/core/modules/help/help_topics/core.content_structure.html.twig");
    }
