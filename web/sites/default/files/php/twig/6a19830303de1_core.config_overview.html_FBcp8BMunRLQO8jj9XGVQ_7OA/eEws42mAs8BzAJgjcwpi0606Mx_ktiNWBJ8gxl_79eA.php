...
class __TwigTemplate_dca731ca64c4cead2d06392ff09872dd extends Template
{
...
<dl>
  ...
  <dd>";
        // line 27
        yield t("Default configuration can be defined by a module, theme, or installation profile in its <em>config/install</em> or <em>config/optional</em> directories. Configuration is provided in YAML files (file extension .yml); YAML is a human-readable data serialization standard that is used by the core software for several purposes. Once the default configuration has been imported into the site\x27s active configuration (through installing the extension), that configuration is owned by the site, not the extension. This means that future updates of the extension will not override the site\x27s active configuration for that extension.", []);
        yield "</dd>
</dl>
<h2>";
        // line 29
...
<dl>
  ...
  <dd>";
        // line 39
        yield t("The configuration sync directory location is set in the site\x27s <em>settings.php</em> file. When configuration is exported, the active configuration is exported and described in YAML files which are stored in the configuration sync directory. After the first export, the system compares the site\x27s active configuration with the configuration data in the sync directory and will only export active configuration items that are different than their counterparts in the sync directory.", []);
        yield "</dd>
</dl>
<h2>";
        // line 41
...
<p>";
        // line 42
        yield t("Configuration management tasks, such as exporting or importing configuration and synchronizing configuration, can be done either through the administrative UI provided by the core Configuration Manager module or a command-line interface (CLI) tool. Defining a configuration sync directory path other than the default value requires read/write access to the site\x27s <em>settings.php</em> file.", []);
        yield "</p>
<p>";
        // line 43
...
<ul>
  ...
  <li>";
    ...
    {
        return new Source("", "@help_topics/core.config_overview.html.twig", "/home/karnven/drupal/web/core/modules/help/help_topics/core.config_overview.html.twig");
    }
