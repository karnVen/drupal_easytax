...
class __TwigTemplate_3bc496798b77d11df1e23a6e587cc53f extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 7
        $context["account_settings_link_text"] = ('' === $tmp = implode('', iterator_to_array((function () use (&$context, $macros, $blocks) {
...
<ul>
  ...
  <li>";
        // line 23
        yield t("[user:display-name]: The user\x27s displayed name.", []);
        yield "</li>
  <li>";
        // line 24
        yield t("[user:account-name]: The user\x27s account name.", []);
        yield "</li>
  <li>";
        // line 25
        yield t("[user:mail]: The user\x27s email alias.", []);
        yield "</li>
  <li>";
        // line 26
...
<ol>
  ...
  <li>";
    ...
    {
        return new Source("", "@help_topics/user.security_account_settings.html.twig", "/home/karnven/drupal/web/core/modules/user/help_topics/user.security_account_settings.html.twig");
    }
