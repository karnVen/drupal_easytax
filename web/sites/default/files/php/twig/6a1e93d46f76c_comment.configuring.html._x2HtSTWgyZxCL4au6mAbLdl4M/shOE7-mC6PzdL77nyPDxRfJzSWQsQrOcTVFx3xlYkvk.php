...
class __TwigTemplate_6450cb3b27927b6d5078516683003bb7 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 9
        $context["comment_permissions_link_text"] = ('' === $tmp = implode('', iterator_to_array((function () use (&$context, $macros, $blocks) {
            // line 10
...
<p>";
        // line 18
        yield t("In order to follow these steps, the Field UI module must be installed. You\x27ll need the Comment module\x27s <em>@comment_permissions_link</em> permission, in order to change comment settings for a comment field. You\x27ll also need to have the appropriate permission for adding fields to the entity type or subtype that the comments are attached to. For example, to add a comment field to content items provided by the Node module, you would need the Node module\x27s <em>Administer content types</em> permission.", ["@comment_permissions_link" => $this->env->getExtension(\Drupal\Core\Template\TwigExtension::class)->renderVar(($context["comment_permissions_link"] ?? null)), ]);
        yield "</p>
<h2>";
        // line 19
        yield t("Steps", []);
...
<ol>
  ...
  <li>";
        // line 22
        yield t("On the first field settings page, choose the <em>Comment type</em> to use for this entity type or sub-type. You\x27ll also notice that the <em>Allowed number of values</em> field cannot be changed for comment fields.", []);
        yield "</li>
  <li>";
        // line 23
...
<ul>
  <li><a href=\"https://www.drupal.org/docs/8/core/modules/comment/administering-a-content-types-comment-settings\">";
    ...
    {
        return new Source("", "@help_topics/comment.configuring.html.twig", "/home/karnven/drupal/web/core/modules/comment/help_topics/comment.configuring.html.twig");
    }
