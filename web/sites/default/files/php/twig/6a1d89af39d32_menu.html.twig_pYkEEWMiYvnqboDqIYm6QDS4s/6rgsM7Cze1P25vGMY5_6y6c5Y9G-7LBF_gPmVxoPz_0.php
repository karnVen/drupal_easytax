...
class __TwigTemplate_27526029f55eee99c24a4cb14e9b5688 extends Template
{
...
$context["item"], "in_active_trail", [], "any", false, false, true, 52)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("menu__item--active-trail") : ("")), (((($tmp = CoreExtension::getAttribute($this->env, $this->source,                     // line 53
$context["item"], "below", [], "any", false, false, true, 53)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("menu__item--has-children") : (""))];
                    // line 56
                    yield "
        ";
                    // line 57
...
$context["item"], "below", [], "any", false, false, true, 62)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("menu__link--has-children") : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/olivero/templates/navigation/menu.html.twig", "/home/karnven/drupal/web/core/themes/olivero/templates/navigation/menu.html.twig");
    }
