...
class __TwigTemplate_4a3f4ba5efb4662da4a06951d99cf447 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 8
        $context["search_link_text"] = ('' === $tmp = implode('', iterator_to_array((function () use (&$context, $macros, $blocks) {
            yield t("Search", []);
            yield from [];
...
<p>";
        // line 21
        yield t("As an alternative to the core Search module\x27s system of search pages, you can use contributed modules to provide site search. For example, the <a href=\"https://www.drupal.org/project/apachesolr\">Apache Solr</a> and <a href=\"https://www.drupal.org/project/sphinx\">Sphinx</a> contributed modules use third-party technology to provide site search.", []);
        yield "</p>
<h2>";
        // line 22
...
<ul>
  <li>";
    ...
    {
        return new Source("", "@help_topics/search.overview.html.twig", "/home/karnven/drupal/web/core/modules/search/help_topics/search.overview.html.twig");
    }
